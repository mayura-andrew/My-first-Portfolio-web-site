	...
	e.fn.prettyPhoto = function (s) {
			...
			$pp_pic_holder.animate(
				{
					top: projectedTop,
					left:
						v / 2 - a["containerWidth"] / 2 < 0 ? 0 : v / 2 - a["containerWidth"] / 2,
		...
		function C() {
			if (
				...
				itemWidth = 52 + 5;
				navWidth =
					settings.theme == "facebook" || settings.theme == "pp_default" ? 50 : 30;
			...
			$pp_pic_holder.fadeIn(function () {
				...
				switch (S(pp_images[set_position])) {
					...
					case "vimeo":
						...
						movie =
							"http://player.vimeo.com/video/" + n[3] + "?title=0&byline=0&portrait=0";
						if (settings.autoplay) movie += "&autoplay=1;";
